...
(define and-sentence
  (def-frame :name "s-and" :parent_concept sentence-concept :parent_frame None
    :depth 8
    :sub_frames (StructureSet and-sub-frame-1 and-sub-frame-2)
    :concepts (StructureSet)
...
(define s-and-vp-1
  (def-letter-chunk :name None
    :locations (list vp-location
		     (Location (list) and-sentence-output)
		     (Location (list) and-sub-frame-1-output))
    :left_branch (StructureSet s-and-verb-1)
    :right_branch (StructureSet s-and-predicate-1)
    :parent_space and-sub-frame-1-output))
...
(define s-and-clause-1
  (def-letter-chunk :name None
    :locations (list sentence-location
		     (Location (list) and-sentence-output)
		     (Location (list) and-sub-frame-1-output))
    :left_branch (StructureSet s-and-subject-1)
    :right_branch (StructureSet s-and-vp-1)
    :parent_space and-sub-frame-1-output))
...
(define s-and-vp-2
  (def-letter-chunk :name None
    :locations (list vp-location
		     (Location (list) and-sentence-output)
		     (Location (list) and-sub-frame-2-output))
    :left_branch (StructureSet s-and-verb-2)
    :right_branch (StructureSet s-and-predicate-2)
    :parent_space and-sub-frame-2-output))
...
(define s-and-clause-2
  (def-letter-chunk :name None
    :locations (list sentence-location
		     (Location (list) and-sentence-output)
		     (Location (list) and-sub-frame-2-output))
    :left_branch (StructureSet s-and-subject-2)
    :right_branch (StructureSet s-and-vp-2)
    :parent_space and-sub-frame-2-output))
...
(define conjunction-super-chunk
  (def-letter-chunk :name None
    :locations (list conj-location
		     (Location (list) and-sentence-output))
    :left_branch (StructureSet s-and)
    :right_branch (StructureSet s-and-clause-2)))
(define sentence-super-chunk
  (def-letter-chunk :name None
    :locations (list sentence-location
		     (Location (list) and-sentence-output))
    :left_branch (StructureSet s-and-clause-1)
