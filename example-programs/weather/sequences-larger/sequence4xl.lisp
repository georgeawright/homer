...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   (Location (list (list 21)) temperature-space)
		   (Location (list (list 0)) time-space)
		   (Location (list (list 1 6)) location-space))
  :parent_space input-space)
(def-chunk
  :is_raw True
  :locations (list (Location (list) input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   ...
		   (Location (list (list 0)) time-space)
		   (Location (list (list 2 5)) location-space))
  :parent_space input-space)
(def-chunk
  :is_raw True
  :locations (list (Location (list) input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   ...
		   (Location (list (list 0)) time-space)
		   (Location (list (list 2 7)) location-space))
  :parent_space input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   (Location (list (list 23)) temperature-space)
		   (Location (list (list 0)) time-space)
		   (Location (list (list 3 6)) location-space))
  :parent_space input-space)
(def-chunk
  :is_raw True
  :locations (list (Location (list) input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   ...
		   (Location (list (list 0)) time-space)
		   (Location (list (list 4 5)) location-space))
  :parent_space input-space)
(def-chunk
  :is_raw True
  :locations (list (Location (list) input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   (Location (list (list 22)) temperature-space)
		   (Location (list (list 0)) time-space)
		   (Location (list (list 4 7)) location-space))
  :parent_space input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   (Location (list (list 23)) temperature-space)
		   (Location (list (list 0)) time-space)
		   (Location (list (list 5 6)) location-space))
  :parent_space input-space)
(def-chunk
  :is_raw True
  :locations (list (Location (list) input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   (Location (list (list 23)) temperature-space)
		   (Location (list (list 0)) time-space)
		   (Location (list (list 6 3)) location-space))
  :parent_space input-space)
(def-chunk
  :is_raw True
  :locations (list (Location (list) input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   (Location (list (list 21)) temperature-space)
		   (Location (list (list 0)) time-space)
		   (Location (list (list 6 5)) location-space))
  :parent_space input-space)
(def-chunk
  :is_raw True
  :locations (list (Location (list) input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   (Location (list (list 14)) temperature-space)
		   (Location (list (list 0)) time-space)
		   (Location (list (list 6 7)) location-space))
  :parent_space input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   (Location (list (list 13)) temperature-space)
		   (Location (list (list 0)) time-space)
		   (Location (list (list 7 2)) location-space))
  :parent_space input-space)
(def-chunk
  :is_raw True
  :locations (list (Location (list) input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   (Location (list (list 21)) temperature-space)
		   (Location (list (list 0)) time-space)
		   (Location (list (list 7 4)) location-space))
  :parent_space input-space)
(def-chunk
  :is_raw True
  :locations (list (Location (list) input-space)
...
(def-chunk
  ...
  :locations (list (Location (list) input-space)
		   (Location (list (list 12)) temperature-space)
		   (Location (list (list 0)) time-space)
		   (Location (list (list 7 6)) location-space))
  :parent_space input-space)
(def-chunk
  :is_raw True
  :locations (list (Location (list) input-space)
