...
hyper_parameters_files = [
    "hyper_parameters_files/h1.json",
    "hyper_parameters_files/h2.json",
    "hyper_parameters_files/h3.json",
    "hyper_parameters_files/h4.json",
    "hyper_parameters_files/h5.json",
    "hyper_parameters_files/h6.json",
    "hyper_parameters_files/h7.json",
    "hyper_parameters_files/h8.json",
    "hyper_parameters_files/h9.json",
