class HyperParameters:
    ...
    WORLDVIEW_QUALITY_PROPORTION_OF_INPUT_WEIGHT = 0.25
    WORLDVIEW_QUALITY_VIEW_QUALITY_WEIGHT = 0.25
    WORLDVIEW_QUALITY_NUMBER_OF_FRAMES_WEIGHT = 0.25
    WORLDVIEW_QUALITY_COHESION_WEIGHT = 0.25
