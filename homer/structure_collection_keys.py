...
chunking_exigency = lambda x: x.chunking_exigency
corresponding_exigency = lambda x: x.corresponding_exigency
labeling_exigency = lambda x: x.labeling_exigency
relating_exigency = lambda x: x.relating_exigency
