...
def test_most_active(a_activation, b_activation, expected):
    ...
    a_activation_pattern.as_scalar = Mock()
    a_activation_pattern.as_scalar.side_effect = [a_activation]
    b_activation_pattern = Mock()
    b_activation_pattern.as_scalar = Mock()
    b_activation_pattern.as_scalar.side_effect = [b_activation]
